...
// 73 Fontes + Cor Azul Estadão
// ============================================

const feeds = [
    // GERAL - Brasileiras (9)
    { source: 'Inovação Tecnológica', url: 'https://www.inovacaotecnologica.com.br/rss.xml', color: '#1a3c6e', category: 'Geral', region: 'nacional' },
    { source: 'Canaltech', url: 'https://canaltech.com.br/rss/', color: '#28548c', category: 'Geral', region: 'nacional' },
    { source: 'Olhar Digital', url: 'https://olhardigital.com.br/feed/', color: '#1a3c6e', category: 'Geral', region: 'nacional' },
    { source: 'Tecmundo', url: 'https://www.tecmundo.com.br/rss', color: '#28548c', category: 'Geral', region: 'nacional' },
    { source: 'ABStartups', url: 'https://abstartups.com.br/feed/', color: '#1a3c6e', category: 'Geral', region: 'nacional' },
    { source: 'USP Poli', url: 'https://www.poli.usp.br/feed/', color: '#28548c', category: 'Geral', region: 'nacional' },
    { source: 'UNICAMP FEM', url: 'https://www.fem.unicamp.br/index.php/feed/', color: '#1a3c6e', category: 'Geral', region: 'nacional' },
    { source: 'UFMG Engenharia', url: 'https://www.eng.ufmg.br/feed/', color: '#28548c', category: 'Geral', region: 'nacional' },
    { source: 'UFRJ COPPE', url: 'https://www.coppe.ufrj.br/rss', color: '#1a3c6e', category: 'Geral', region: 'nacional' },
    // GERAL - Internacionais (10)
    { source: 'MIT Technology Review', url: 'https://www.technologyreview.com/feed/', color: '#1a3c6e', category: 'Geral', region: 'internacional' },
    { source: 'Wired', url: 'https://www.wired.com/feed/rss', color: '#28548c', category: 'Geral', region: 'internacional' },
    { source: 'Ars Technica', url: 'https://feeds.arstechnica.com/arstechnica/index', color: '#1a3c6e', category: 'Geral', region: 'internacional' },
    { source: 'MIT MechE', url: 'https://meche.mit.edu/rss.xml', color: '#28548c', category: 'Geral', region: 'internacional' },
    { source: 'Stanford Engineering', url: 'https://engineering.stanford.edu/rss.xml', color: '#1a3c6e', category: 'Geral', region: 'internacional' },
    { source: 'UC Berkeley Eng', url: 'https://engineering.berkeley.edu/rss.xml', color: '#28548c', category: 'Geral', region: 'internacional' },
    { source: 'Purdue Engineering', url: 'https://engineering.purdue.edu/rss.xml', color: '#1a3c6e', category: 'Geral', region: 'internacional' },
    { source: 'ETH Zurich MechE', url: 'https://mavt.ethz.ch/rss.xml', color: '#28548c', category: 'Geral', region: 'internacional' },
    { source: 'Cambridge Engineering', url: 'https://www.eng.cam.ac.uk/rss.xml', color: '#1a3c6e', category: 'Geral', region: 'internacional' },
    { source: 'Carnegie Mellon Eng', url: 'https://engineering.cmu.edu/rss.xml', color: '#28548c', category: 'Geral', region: 'internacional' },
    // EMBARCADOS (6)
    { source: 'Embarcados', url: 'https://www.embarcados.com.br/feed/', color: '#1a3c6e', category: 'Embarcados', region: 'nacional' },
    { source: 'Portal Vida de Silício', url: 'https://portal.vidadesilicio.com.br/feed/', color: '#28548c', category: 'Embarcados', region: 'nacional' },
    { source: 'FilipeFlop', url: 'https://www.filipeflop.com/blog/feed/', color: '#1a3c6e', category: 'Embarcados', region: 'nacional' },
    { source: 'Hackaday', url: 'https://hackaday.com/blog/feed/', color: '#28548c', category: 'Embarcados', region: 'internacional' },
    { source: 'Embedded.com', url: 'https://www.embedded.com/feed/', color: '#1a3c6e', category: 'Embarcados', region: 'internacional' },
    { source: 'Adafruit Blog', url: 'https://blog.adafruit.com/feed/', color: '#28548c', category: 'Embarcados', region: 'internacional' },
    // INDÚSTRIA (10)
    { source: 'ABINEE', url: 'https://www.abinee.org.br/feed/', color: '#1a3c6e', category: 'Indústria', region: 'nacional' },
    { source: 'ABIMAQ', url: 'https://www.abimaq.org.br/rss', color: '#28548c', category: 'Indústria', region: 'nacional' },
    { source: 'ABDI', url: 'https://www.abdi.com.br/rss', color: '#1a3c6e', category: 'Indústria', region: 'nacional' },
    { source: 'BNDES', url: 'https://www.bndes.gov.br/wps/portal/site/home/noticias/rss', color: '#28548c', category: 'Indústria', region: 'nacional' },
    { source: 'CNI', url: 'https://noticias.portaldaindustria.com.br/rss/', color: '#1a3c6e', category: 'Indústria', region: 'nacional' },
    { source: 'Revista Eletrônica', url: 'https://www.revistaeletronica.com.br/feed/', color: '#28548c', category: 'Indústria', region: 'nacional' },
    { source: 'CIMM', url: 'https://www.cimm.com.br/rss/', color: '#1a3c6e', category: 'Indústria', region: 'nacional' },
    { source: 'Electronics Weekly', url: 'https://www.electronicsweekly.com/feed/', color: '#28548c', category: 'Indústria', region: 'internacional' },
    { source: 'Electronics For You', url: 'https://www.electronicsforu.com/feed', color: '#1a3c6e', category: 'Indústria', region: 'internacional' },
    { source: 'SMTnet', url: 'https://www.smtnet.com/rss/news.xml', color: '#28548c', category: 'Indústria', region: 'internacional' },
    // PROJETOS (5)
    { source: 'Instituto NCB', url: 'https://www.institutoncb.com.br/feed/', color: '#1a3c6e', category: 'Projetos', region: 'nacional' },
    { source: 'Eletrônica Geral', url: 'https://www.eletronicageral.com/feed/', color: '#28548c', category: 'Projetos', region: 'nacional' },
    { source: 'All About Circuits', url: 'https://www.allaboutcircuits.com/rss/', color: '#1a3c6e', category: 'Projetos', region: 'internacional' },
    { source: 'Electronic Design', url: 'https://www.electronicdesign.com/rss', color: '#28548c', category: 'Projetos', region: 'internacional' },
    { source: 'EEWeb', url: 'https://www.eeweb.com/feed/', color: '#1a3c6e', category: 'Projetos', region: 'internacional' },
    // SEMICONDUTORES (5)
    { source: 'Chip Brasil', url: 'https://chipbrasil.com.br/feed/', color: '#1a3c6e', category: 'Semicondutores', region: 'nacional' },
    { source: 'EETimes', url: 'https://www.eetimes.com/feed/', color: '#28548c', category: 'Semicondutores', region: 'internacional' },
    { source: 'IEEE Spectrum', url: 'https://spectrum.ieee.org/feeds/topic/semiconductors.rss', color: '#1a3c6e', category: 'Semicondutores', region: 'internacional' },
    { source: 'Semiconductor Engineering', url: 'https://semiengineering.com/feed/', color: '#28548c', category: 'Semicondutores', region: 'internacional' },
    { source: 'AnandTech', url: 'https://www.anandtech.com/rss/', color: '#1a3c6e', category: 'Semicondutores', region: 'internacional' },
    // AERONÁUTICA (10)
    { source: 'Aero Magazine', url: 'https://aeromagazine.uol.com.br/feed/', color: '#1a3c6e', category: 'Aeronáutica', region: 'nacional' },
    { source: 'Cavok Brasil', url: 'https://www.cavok.com.br/feed/', color: '#28548c', category: 'Aeronáutica', region: 'nacional' },
    { source: 'Poder Aéreo', url: 'https://www.poderaereo.com.br/feed/', color: '#1a3c6e', category: 'Aeronáutica', region: 'nacional' },
    { source: 'Defesa Aérea & Naval', url: 'https://www.defesaaereanaval.com.br/feed/', color: '#28548c', category: 'Aeronáutica', region: 'nacional' },
    { source: 'Aeroin', url: 'https://aeroin.net/feed/', color: '#1a3c6e', category: 'Aeronáutica', region: 'nacional' },
    { source: 'Aeroflap', url: 'https://www.aeroflap.com.br/feed/', color: '#28548c', category: 'Aeronáutica', region: 'nacional' },
    { source: 'ITA', url: 'https://www.ita.br/rss', color: '#1a3c6e', category: 'Aeronáutica', region: 'nacional' },
    { source: 'Aviation Week', url: 'https://aviationweek.com/rss.xml', color: '#28548c', category: 'Aeronáutica', region: 'internacional' },
    { source: 'FlightGlobal', url: 'https://www.flightglobal.com/rss', color: '#1a3c6e', category: 'Aeronáutica', region: 'internacional' },
    { source: 'AINonline', url: 'https://www.ainonline.com/rss.xml', color: '#28548c', category: 'Aeronáutica', region: 'internacional' },
    // AUTOMOTIVA (11)
    { source: 'Automotive Business', url: 'https://www.automotivebusiness.com.br/feed/', color: '#1a3c6e', category: 'Automotiva', region: 'nacional' },
    { source: 'AutoEsporte', url: 'https://autoesporte.globo.com/rss/feed.xml', color: '#28548c', category: 'Automotiva', region: 'nacional' },
    { source: 'Jornal do Carro', url: 'https://jornaldocarro.estadao.com.br/feed/', color: '#1a3c6e', category: 'Automotiva', region: 'nacional' },
    { source: 'Quatro Rodas', url: 'https://quatrorodas.abril.com.br/feed/', color: '#28548c', category: 'Automotiva', region: 'nacional' },
    { source: 'Motor Show', url: 'https://motorshow.com.br/feed/', color: '#1a3c6e', category: 'Automotiva', region: 'nacional' },
    { source: 'CarBlog', url: 'https://www.car.blog.br/feed/', color: '#28548c', category: 'Automotiva', region: 'nacional' },
    { source: 'Auto Papo', url: 'https://autopapo.uol.com.br/feed/', color: '#1a3c6e', category: 'Automotiva', region: 'nacional' },
    { source: 'Autoblog', url: 'https://www.autoblog.com/rss.xml', color: '#28548c', category: 'Automotiva', region: 'internacional' },
    { source: 'Car and Driver', url: 'https://www.caranddriver.com/rss/all.xml', color: '#1a3c6e', category: 'Automotiva', region: 'internacional' },
    { source: 'Motor1', url: 'https://www.motor1.com/rss/news/all/', color: '#28548c', category: 'Automotiva', region: 'internacional' },
    { source: 'Automotive News', url: 'https://www.autonews.com/rss/feed.xml', color: '#1a3c6e', category: 'Automotiva', region: 'internacional' },
    // BENS DE CONSUMO (13)
    { source: 'Techtudo', url: 'https://www.techtudo.com.br/rss/', color: '#1a3c6e', category: 'Bens de Consumo', region: 'nacional' },
    { source: 'Tudocelular', url: 'https://www.tudocelular.com/rss/', color: '#28548c', category: 'Bens de Consumo', region: 'nacional' },
    { source: 'Gizmodo Brasil', url: 'https://gizmodo.uol.com.br/feed/', color: '#1a3c6e', category: 'Bens de Consumo', region: 'nacional' },
    { source: 'Tecnoblog', url: 'https://tecnoblog.net/feed/', color: '#28548c', category: 'Bens de Consumo', region: 'nacional' },
    { source: 'TechCrunch', url: 'https://techcrunch.com/feed/', color: '#1a3c6e', category: 'Bens de Consumo', region: 'internacional' },
    { source: 'The Verge', url: 'https://www.theverge.com/rss/index.xml', color: '#28548c', category: 'Bens de Consumo', region: 'internacional' },
    { source: 'CNET', url: 'https://www.cnet.com/rss/news/', color: '#1a3c6e', category: 'Bens de Consumo', region: 'internacional' },
    { source: 'Engadget', url: 'https://www.engadget.com/rss.xml', color: '#28548c', category: 'Bens de Consumo', region: 'internacional' },
    { source: "Tom's Hardware", url: 'https://www.tomshardware.com/feeds/all', color: '#1a3c6e', category: 'Bens de Consumo', region: 'internacional' },
    { source: 'Android Central', url: 'https://www.androidcentral.com/feed', color: '#28548c', category: 'Bens de Consumo', region: 'internacional' },
    { source: '9to5Mac', url: 'https://9to5mac.com/feed/', color: '#1a3c6e', category: 'Bens de Consumo', region: 'internacional' },
    { source: 'GSM Arena', url: 'https://www.gsmarena.com/rss-news-reviews.php3', color: '#28548c', category: 'Bens de Consumo', region: 'internacional' },
    { source: 'TechRadar', url: 'https://www.techradar.com/rss', color: '#1a3c6e', category: 'Bens de Consumo', region: 'internacional' }
];
...
function createCard(news) {
    ...
    let imgHtml;
    if (news.image) { imgHtml = `<div class="card-image" style="background-image:url('${news.image}')"><span class="card-category">${news.category}</span></div>`; } else { imgHtml = `<div class="card-image" style="background:#e8f0fe;"><span class="card-category">${news.category}</span></div>`; }
